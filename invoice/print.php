<?php 
  ...
  class PDF extends FPDF
  {
    function Header(){
      ...
      $this->Cell(50,10,"SRE MAHALIAMMAN ELECTRICALS",0,1);
      $this->SetFont('Arial','',14);
      $this->Cell(50,7,"Kunnathur Road,",0,1);
      $this->Cell(50,7,"Perundurai 638052.",0,1);
      $this->Cell(50,7,"PH : 9842721554",0,1);
    ...
    function Footer(){
      ...
      $this->SetY(-50);
      $this->SetFont('Arial','B',12);
      $this->Cell(0,10,"SRE MAHALIAMMAN ELECTRICALS",0,1,"R");
      $this->Ln(15);
      $this->SetFont('Arial','',12);
